...
gulp.task('concatCss',function(){
	...
	.pipe(sourcemaps.write("./less"))//sourcemaps生成文件的位置，此处为和css输出地址一致
	.pipe(gulp.dest('css'))//css输出地址
...
//  });
    gulp.watch(lessUrl, ['concatCss']);//执行concatCss任务
//  gulp.watch("template/**/*.html").on('change', reload);//监控html变化并刷新浏览器
